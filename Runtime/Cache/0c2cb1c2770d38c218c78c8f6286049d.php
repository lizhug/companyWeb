...
<div id="content" class="tabbable tabs-left">
	<ul class="nav nav-tabs nav-stacked" id="siderbar">
		<li class="active"><a href="#t1" data-toggle="tab">公司资讯</a></li>
		<li id="t11"><a href="#t1" data-toggle="tab">添加资讯内容</a></li>
		<li id="t12"><a href="#tt1" data-toggle="tab">修改资讯</a></li>
		<li><a href="#t2" data-toggle="tab">公司基本信息(显示在侧边栏)</a></li>
		<li><a href="#t3" data-toggle="tab">公司简介</a></li>
		...
		<li><a href="#t6" data-toggle="tab">供应信息</a></li>
		<li id="t61"><a href="#t6" data-toggle="tab">添加供应信息</a></li>
		<li id="t62"><a href="#t611" data-toggle="tab">修改供应信息</a></li>
		<li><a href="#t7" data-toggle="tab">人才招聘</a></li>
	...
	<div class="tab-content">
		...
		<div class="tab-pane" id="t2">
			<span class="lead">公司基本信息(显示在侧边栏)</span>
		...
		<!-- 修改供应信息 -->
		<div class="tab-pane" id="t611">
			<span class="lead">修改供应信息</span>
			<table class="table table-bordered">
			<?php if(is_array($offerList)): $i = 0; $__LIST__ = $offerList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr><td>编号</td><td><?php echo ($vo['id']); ?></td><td><?php echo ($vo['title']); ?></td><td><a href="javascript:void(0);" class="btn btn-success change">修改</a></td><td><a href="javascript:void(0);" class="btn btn-danger">删除</a></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
			<tr><td colspan="5"><?php echo ($page); ?></td></tr>
			</table>
			<div class="displayNone">
				<input type="text" placeholder="咨询标题"/>
				<textarea type="text" name="textt6" id="textt6" style="width:100%;"></textarea>  
				<a href="javascript:void(0);" class="btn btn-success">提交</a>
				<a href="javascript:void(0);" class="btn">取消</a>
			</div>
		</div>
...
<script type="text/javascript">    
	...
	editor6.render("text6");//这里认的是上面控件的ID 
	editort6.render("textt6");//这里认的是上面控件的ID  	
