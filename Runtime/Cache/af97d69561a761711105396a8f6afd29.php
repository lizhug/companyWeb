...
<body class="container" id="main">
	...
	<div class="help-block">
		<div id="content">
			...
			<div id="article">
			<span><?php echo ($page['coverText']); ?></span>
			<div class="help-block spec"><span>发布日期: <?php echo ($page['date']); ?></span><span>浏览次数: <?php echo ($page['count']); ?></span><span>所属类别: <?php echo ($page['type']); ?></span></div>
