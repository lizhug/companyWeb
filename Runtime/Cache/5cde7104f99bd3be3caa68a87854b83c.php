...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./Common/css/Home/index.css" />
</head>
<body class="container" id="main">
	...
	<div class="help-block">
		...
		<div id="content" class="span8 pull-left">
			<span><img src="./Common/images/icon.jpg" alt="icon" />公司资讯 <span>COMPANY NEWS</span></span>
			<ul class="unstyled">
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="__APP__/Content/info/id/<?php echo ($vo['id']); ?>"><?php echo ($vo['title']); ?></a><span class="pull-right"><?php echo ($vo['date']); ?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>
