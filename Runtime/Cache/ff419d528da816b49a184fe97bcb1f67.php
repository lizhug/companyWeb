...
<body class="container" id="main">
	...
	<div class="help-block">
		<div id="siderbar" class="span3 pull-left">
			<div id="list">
				<span><img src="./Common/images/icon3.jpg" alt="icon" />设备列表</span>
				<ul class="unstyled">
					<li><img src="./Common/images/li.jpg" />设备展示</li>
				</ul>
				<ul id="next">
					<ul id="next">
		...
		<div id="content" class="span8 pull-left">
			<span><img src="./Common/images/icon.jpg" alt="icon" />设备展示 <span>Device</span></span>
			<div id="cshow">
